...
var (
	...
	consumerWitnessBuildTotal       = metrics.NewRegisteredCounter("ubt/consumer/witness/build/total", nil)
	consumerWitnessBuildFailures    = metrics.NewRegisteredCounter("ubt/consumer/witness/build/failures", nil)
	consumerWitnessBuildLatency     = metrics.NewRegisteredTimer("ubt/consumer/witness/build/latency", nil)
	consumerWitnessBlobBytesTotal   = metrics.NewRegisteredCounter("ubt/consumer/witness/blob/bytes/total", nil)
	queryWitnessHitTotal            = metrics.NewRegisteredCounter("ubt/query/witness/hit/total", nil)
	queryWitnessMissTotal           = metrics.NewRegisteredCounter("ubt/query/witness/miss/total", nil)
