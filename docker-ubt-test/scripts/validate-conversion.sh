...
echo ""
echo "1. Check UBT logs for conversion status:"
echo "   ./scripts/check-ubt-logs.sh progress"
echo ""
echo "2. Verify no errors in logs:"
echo "   ./scripts/check-ubt-logs.sh errors"
echo ""
echo "3. For detailed UBT status, check:"
echo "   docker exec geth-ubt-test geth attach --exec 'debug.ubtConversionStatus()'"
echo "   (Note: RPC method needs to be implemented)"
echo ""
